    ...
    <jsp:body>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="student/user/save_subject.do" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
        ...
        <script type="application/javascript">
            function doSubmit() {
                ...
                var selectSubject =$('[name="duallistbox_demo1[]"]').val();

                alert("已选择的课程编号为："+($('[name="duallistbox_demo1[]"]').val())+"。   是否确定选择该课程");
                window.location.href="student/user/save_subject.do?studentId=${studentId}&selectSubject="+selectSubject;
            }
