                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="student/grade/save_update.do" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="gradeId" name="gradeId" maxlength="50" value="${grade.gradeId}"
                                               class="required form-control" readonly="readonly"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="gradeName" name="gradeName" maxlength="50" value="${grade.gradeName}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="gradeNumber" name="gradeNumber"
                                               maxlength="50" value="${grade.gradeNumber}"
                                               class="required form-control"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="gradeAverage" name="gradeAverage"
                                               maxlength="50" value="${grade.gradeAverage}"
                                               class="required form-control"/>
                                    </div>
                                </div>
