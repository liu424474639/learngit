                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="student/subject/save_update.do" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="subjectName" name="subjectName" maxlength="50" value="${subject.subjectName}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="subjectNumber" name="subjectNumber"
                                               maxlength="50" value="${subject.subjectNumber}"
                                               class="required form-control"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="subjectAverage" name="subjectAverage"
                                               maxlength="50" value="${subject.subjectAverage}"
                                               class="required form-control"/>
                                    </div>
                                </div>
