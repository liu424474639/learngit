                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="student/user/save_update.do?id=${id}" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="Id" name="Id" maxlength="50" value="${id}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="courseNumber" name="courseNumber" maxlength="50" value="${student.courseNumber}"
                                               class="required form-control"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="average" name="average" maxlength="50" value="${student.average}"
                                               class="required form-control"/>
                                    </div>
                                </div>
