                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="student/user/save_doScore.do?studentId=${studentId}" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
                                ...
                                <c:forEach items="${subjects}" var="subject" varStatus="status">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" autocomplete="off" id="${subject}" name="${subject}" maxlength="50" value="学科分数"
                                ...
                                <sec:authorize ifAnyGranted="OPT_USER_ADD,OPT_USER_EDIT">
                                    <div class="clearfix form-actions">
                                        <div class="text-center">
                                            <input id="confirm" class="btn btn-info" type="submit" value="提交">
